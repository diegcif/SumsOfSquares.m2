...
\noindent
Although the result of the semidefinite programming solver is in floating point, the \SOS package attempts to round it to obtain a rational Gram matrix~\cite{peyrl2008computing}.
