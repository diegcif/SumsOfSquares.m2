...
This allows, in particular, to find lower bounds for a polynomial function $f(x)$,
by finding the largest $t$ such that $f(x)-t$ is SOS.
Here we apply this method to the dehomogenized Motzkin polynomial $f(x)=x^4{+}x^2{+}z^6{-}3 x^2 z^2$.
{\small
\begin{verbatim}
i12 : R = QQ[x,z][t];
...
\textbf{Mention recoverSolution here}.
